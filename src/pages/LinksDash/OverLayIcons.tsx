...
// هزرد ايقون هنا للتليفون المحمول 
// هظبط الصوره اللى فى ال setting bar  واخليها اول حرف من اسم المستخدم 
...
export default function OverLayIcons({overLayiconsState,setoverLayiconsState}:OverLayIconsProps) {
